# Learn PyTorch for Deep Learning — Immersive Edition

> **Attribution:** All course content (notebooks, text, images) is the work of **Daniel Bourke**, created for the [Zero to Mastery Learn PyTorch for Deep Learning course](https://dbourke.link/ZTMPyTorch). Original repository: [mrdbourke/pytorch-deep-learning](https://github.com/mrdbourke/pytorch-deep-learning) (MIT licensed).
>
> This fork adds an **immersive reading experience** to the documentation site: progress tracking with JSON import/export, a gamified completion percentage, text highlighting & underlining that double as bookmarks, freehand drawing annotations, and improved math rendering. All learning material remains credited to the original author.
